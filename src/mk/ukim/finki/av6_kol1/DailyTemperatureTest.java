...
class DailyMeasurement implements Comparable<DailyMeasurement>{
    ...
    public static DailyMeasurement createDailyMeansurement(String line) {
...
//       }
    ...
    public String toString(char scale) {
        ...
        DoubleSummaryStatistics dss = temperatures.stream()
                .mapToDouble(t -> scale=='C' ? t.getCelsiuis() : t.getFahrenheit())
                .summaryStatistics();
...
class DailyTemperatures{
    ...
    public void readTemperatures(InputStream inputStream) {
        ...
        dailyMeasurements = br.lines()
                .map(line-> DailyMeasurement.createDailyMeansurement(line))
                .collect(Collectors.toList());
    }
