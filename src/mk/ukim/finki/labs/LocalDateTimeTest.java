...
public class LocalDateTimeTest {
    ...
    static LocalDateTime localDateTimeParse() {
         ...
         */
        LocalDateTime res = LocalDateTime.parse ("2015-06-20T23:07:30");
        return res;
    }
    ...
    static LocalDateTime localTimeWith() {
         ...
         */
        LocalDateTime res = ldt.with (TemporalAdjusters.firstDayOfNextMonth ()).truncatedTo (ChronoUnit.HOURS);
        return res;
    }
    ...
    static LocalDateTime localDatePlusMinus() {
         ...
         */
        LocalDateTime res = ldt.plusMonths (10).minusHours (5);
        return res;
    }
