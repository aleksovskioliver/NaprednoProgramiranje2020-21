...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToMinute() {
         ...
         */
        LocalTime res = LocalTime.of (23,07);
        return res;
    }
    ...
    static LocalTime localTimeOfHourToNanoSec() {
         ...
         */
        LocalTime res = LocalTime.of (23,07,03,100000000);
        return res;
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        LocalTime res = lt.minusHours (3).minusMinutes (30).minusSeconds (20).minusNanos (200000000);
        return res;
    }
